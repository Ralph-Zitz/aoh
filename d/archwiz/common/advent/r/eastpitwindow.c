/* Advent - Window On Pit 1 (east) -- Mateese, 18-Aug-96
 *
...
public void create()
{
  ...
  // Main description
  Set(P_INT_SHORT, "East Window On Pit");
  Set(P_INT_LONG,
...
"there peering back at you.\n"
  ...
  // Exits
  AddExit("east", ADVENT("r/y2"));
  Set(P_NOWAY_MSG, "The only passage is back east to Y2.\n");
