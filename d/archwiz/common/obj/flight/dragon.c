...
#define MOVE_PLAYER(str1, str2) \
  ...
  return 1
inherit "std/room";   /* The Dragon is a room */
inherit "lib/money";
string stationnames;
int numstations;
...
buildnames() {
	stationnames = ({
		"/d/avalon/common/village/dragon_port",
	/*	"/d/avalon/common/ireland/forest/2G2", */
		"/d/atlantis/common/room/field/42,53",
		"/d/archwiz/common/room/city/airport2",
	});
...
"You can 'leave' if the dragon is on the ground.\n");
        SetShort(name);
        SetLong("This is a "+name+" of the Nightfall Flightdragon Airways. "+
        ...
        AddSpecialDetail("doors", "doors"); 
        AddSpecialDetail("window", "window");
        Set(P_TRANSPARENT,0);
        doors_open = 0;
        stationnr = 1;
        buildnames();
