/* A Simple Red Rose by Joan 06/03/1999 */
...
void create()
  ...
  SetValue(50);
  SetWeight(50);
  SetLong(({"A Simple Red Rose. You should look at it more closely.", 
"It is an exquisite blood red rose. The petals curl gently at the tips."
...
"You close your eyes as you inhale its delicate light fragrance!\n");
  ...
  "breathtaking.\n","Each petal is blood red and curls at "
  "it's tip.\n"}));
