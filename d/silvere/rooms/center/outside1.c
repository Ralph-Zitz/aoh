...
// last changed:  Joan     [01-Nov-1997]  added some details and stuff
...
varargs void create()
{
   ::create();
   Set(P_INDOORS,0);
   Set(P_INT_SHORT,"West Palace Avenue");
   Set(P_INT_LONG,
"To the east the brownstone palace walls rise high above the ground. "
"A large white statue guards the west palace walls. The avenue "
"opens elegantly to the north and south there. To the west the "
"roads leads into the western and harbour areas of Silvere. Lime "
"trees stand sentry to the north and south sides of the avenue. "
"@@TimeMsg@@\n");

   Set(P_INT_WIZMSG,
" West: to the western part of the city and the harbour.\n"
" East: To a crossing with the road around the palace\n");
   ...
   Set(P_COORDINATES, ({ ({ -60,10,0 }), C_SILVERE }) );

   Set(P_NOWAY_MSG,
"You walk into a tree like an idiot. Somehow you have the feeling that "
" everyone laughs at you.\n");

   AddExit("west",   SIL_CENTER("westenter"));
   AddExit("east",   SIL_CENTER("outside2"));
}
