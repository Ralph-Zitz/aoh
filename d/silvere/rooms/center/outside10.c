...
// Last changed:  Joan     [03-Sept-2001] added lots of stuff
...
"road leads north to palace entrance. Pink and white shrub roses "
"line the base of the wall. @@TimeMsg@@\n");


   Set(P_INT_WIZMSG,
" North: A small place with the entrance into the palace.\n"
" West:  To the west and south part and the harbour\n"
" East:  To the east part of the town.\n");
...
"You walk into the wall like an idiot. Somehow you have the feeling, that\
 everyone laughs at you.\n");
   ...
   AddExit("north", SIL_CENTER("palplace3"));
   AddExit("west",  SIL_CENTER("mainsouth1"));
   AddExit("east",  SIL_CENTER("outside11"));
}
