...
// last changed:  Sonic    [01-Jul-1997]  added coordinates/regions
// changed:       Joan     [03-Sept-2001] added lots of stff
...
"You walk into the wall like an idiot. Somehow you have the feeling, that\
 everyone laughs at you.\n");
   ...
   AddExit("east",  SIL_CENTER("outside14"));
   AddExit("west",  SIL_CENTER("outside12"));
}
