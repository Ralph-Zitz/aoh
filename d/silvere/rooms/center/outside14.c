...
//                Joan     [24-Oct-1997] added some details and sounds
...
varargs void create()
{
   ...
   Set(P_INT_LONG,
"The palace avenue gracefully turns west and north here. "
"Cinnamon trees to the west and lime trees to the east "
"guard the beautiful Lady flowers in thier soft grass "
"beds by the east palace wall. @@TimeMsg@@\n");
...
" North: to the east part.\n");
   ...
   AddDetail( ({"flower","flowers","lady flowers","ladys",
   "lady flower","pink lady flowers"}),"Neat beds of bright pink  "
   "Lady flowers make a blushing border for the tiny trees "
   "and palace wall. They smell wonderful!\n");
...
"You walk into a tree like an idiot. Somehow you have the feeling that\
 everyone laughs at you.\n");
   ...
   AddExit("north", SIL_CENTER("outside15"));
   AddExit("west",  SIL_CENTER("outside13"));
