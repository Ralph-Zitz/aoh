...
"tiny cassia cinnamon trees and purple venus poppys border "
"the base of the east palace wing. @@TimeMsg@@\n");
...
" North: to the east part.\n");
   ...
   AddDetail( ({"flower","flowers","venus poppy","venus poppys",
   "poppys","poppy"}),"Piles of gorgeous purple venus poppys line "
   "the base of the brownstone palace wall.\n");
...
"You walk into a tree like an idiot. Somehow you have the feeling that\
 everyone laughs at you.\n");
   ...
   AddExit("north", SIL_CENTER("outside17"));
   AddExit("south", SIL_CENTER("outside15"));
}
