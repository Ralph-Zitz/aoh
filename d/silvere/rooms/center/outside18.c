...
//                Joan     [18-Oct-1997] added some details and sounds
...
varargs void create()
{
   ...
   Set(P_INT_LONG,
"Lime trees border east side of the wide palace avenue as "
"it gracefully continues to the north and south. To the south "
"the avenue elegantly intersects a road to the east. Delicate "
"tiny cassia cinnamon trees and mounds of precious Morning Stars "
"border the base of the east palace wing. @@TimeMsg@@\n");

   Set(P_INT_WIZMSG,
" South: to the east part of Silvere and other places.\n"
" North: the road around the palace, to the north part.\n");
   ...
   AddDetail( ({"morning star","flower","flowers","morning stars"}),
   "Mounds of gay yellow Morning Stars line the base of the "
   "brownstone wall.\n");
...
"You walk into a tree like an idiot. Somehow you have the feeling that\
 everyone laughs at you.\n");
   ...
   AddExit("north", SIL_CENTER("outside19"));
   AddExit("south", SIL_CENTER("outside17"));
