...
// changed:       Joan     [12-Dec-1997]  added south exit
...
"rear palace wall. To the south a small neat grove of pomegranate "
"trees grows between the main building and the west wing. "
"@@TimeMsg@@\n");

   Set(P_INT_WIZMSG,
"To the south is a small, elegant pomegranate garden. \n"
" East: to the East and sorth part of Silvere and other places.\n"
" west: the road around the palace, to the west part.\n");
   ...
   "Just to your south is a small grove of sweet pomegranate "
   "trees.\n");

   AddDetail( ({"limes","lime"}),"The limes are not ripe yet.\n");

   AddDetail( ({"pomegranate","pomegranates"}),"You can't see "
   "them from here.\n");
...
"You walk into a tree like an idiot. Somehow you have the feeling that\
 everyone laughs at you.\n");
   ...
   AddExit("east", SIL_CENTER("outside20"));
   AddExit("south", SIL_CENTER("garden4"));
   AddExit("west", SIL_CENTER("outside22"));
}
