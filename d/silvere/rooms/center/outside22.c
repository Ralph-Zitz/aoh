...
"rear palace wall. To the south a small neat grove of "
"pomegranate trees grows between the main building and the "
"west wing. @@TimeMsg@@\n");
...
"You walk into a tree like an idiot. Somehow you have the feeling that\
 everyone laughs at you.\n");
   ...
   AddExit("west", SIL_CENTER("outside23"));
   AddExit("south", SIL_CENTER("garden3"));
   AddExit("east", SIL_CENTER("outside21"));
}
