...
varargs void create()
{
   ...
   Set(P_INT_LONG,
"The west side of the wide palace avenue boasts graceful "
"lime trees as it continues gentley to the north and south. "
"The east side of the avenue boasts a myriad of soft "
"pink saliums and a neat row of delicate tiny cassia cinnamon "
"trees hugging the west palace wall. @@TimeMsg@@\n");

   Set(P_INT_WIZMSG,
" North: Follow the road to the north around the palace.\n"
" South: Follow the road east to the entrance of the palace.\n");
   ...
   "A myriad of soft pink saliums hug the base of the "
   "tiny trees and palace wall.\n");
...
"You walk into a tree like an idiot. Somehow you have the feeling that\
 everyone laughs at you.\n");
   ...
   AddExit("south",  SIL_CENTER("outside5"));
   AddExit("north",  SIL_CENTER("outside3"));
}
