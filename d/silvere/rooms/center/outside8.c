...
// changed:       Joan     [08-Sept-2001] added all kinds of stuff
...
" East: To the entrance, the south and east part of the town.\n");

   AddDetail( ({"road","avenue","path"}),"To the east the graceful avenue "
   ...
   Set(P_COORDINATES, ({ ({ -20,40,0 }), C_SILVERE }) );

   Set(P_NOWAY_MSG,
"You walk into the wall like an idiot. Somehow you have the feeling, that\
 everyone laughs at you.\n");

   AddExit("east",  SIL_CENTER("outside9"));
   AddExit("west",  SIL_CENTER("outside7"));
}
