// The place before the western wing of the palace
...
"can be seen all over the basement of the building. To the east is the "
"entrance of the palace. The mainroad to the south starts there also. "
"All over the place are beds with artfully aranged flowers and a beautiful cascades "
"of roses. A beautiful white marble bench is here. @@TimeMsg@@\n");

   Set(P_INT_WIZMSG,
" East:  To the entrance of the palace.\n"
...
"You walk into the wall like an idiot. Somehow you have the feeling, that\
 everyone laughs at you.\n");
   ...
   AddExit("south", SIL_CENTER("palplace1"));
   AddExit("east",  SIL_CENTER("palplace5"));
}
