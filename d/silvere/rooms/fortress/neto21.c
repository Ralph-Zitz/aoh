...
varargs void create()
{
   ::create();
   Set(P_INDOORS,1);
   Set(P_INT_SHORT,"Northwestern corner from northeastern tower");
   Set(P_INT_LONG,
   ...
   Set(P_INT_WIZMSG,
    " South: Entrance to northeastern tower, level 2.\n"
    " East:  NE Corner of NE tower, level 2.\n");
...
//   Set(P_COORDINATES, ({ ({ -50,20,0 }), C_SILVERE }) );
   ...
   AddExit("south",  SIL_FORTRESS("neto23"));
   AddExit("east",   SIL_FORTRESS("neto22"));
