   ...
   switch(({int})NIGHTDAY->QueryState())
   {
      ...
      case ND_PREDAWN..ND_SUNRISE:
         desc+=
          ...
          "making them look aflame. To the north, the first light of "
          "the day crawl across the fields.\n";
         break;
      case ND_TWILIGHT..ND_EVENING:
         desc+=
          "to the north the shadows grow longer in the diminishing "
          "light of the day while to the east the shadow of the fortress "
          "extends across the fields below and the mountains in the "
          "distance are bathed with the last light of the day.\n";
         break;
      case ND_EARLY_MORNING..ND_SUNSET:
         desc+=
          "to the north you can see fields stretching as far as the eye "
          "can see, while looking east you can see fields with the snowy "
          "peaks of the mountains in the distance.\n";
         break;
      default:
         desc+=
          "There is something outside of the tower, but "
...
varargs void create()
{
   ...
   Set(P_INT_LONG,
    ...
    "filled with arrows next to the wall. A bit to the southwest lies a "
    "staircase that blocks the view of the tower entrance.\n");

   Set(P_INT_WIZMSG,
    " South: SE Corner of NE tower, level 2.\n"
    " West:  NW Corner of NE tower, level 2.\n");
   ...
   AddDetail( ({"wall","walls"}),
    ...
    "southwest the staircase blocks view of the doorway while around you "
...
//   Set(P_COORDINATES, ({ ({ -50,20,0 }), C_SILVERE }) );
   ...
   AddExit("south",  SIL_FORTRESS("neto24"));
   AddExit("west",   SIL_FORTRESS("neto21"));
