...
varargs void create()
{
   ::create();
   Set(P_INDOORS,1);
   Set(P_INT_SHORT,"Entrance to the northwestern tower");
   Set(P_INT_LONG,
    ...
    "high and two doors lead out, one to the northern battlement and the "
   ...
   Set(P_INT_WIZMSG,
    " South: Enter western battlement.\n"
    " East:  Enter the north battlement.\n"
    " North: NE Corner of NW tower, level 2.\n"
    " West:  SW Corner of NW tower, level 2.\n"
    " Up:    Top of the NW tower, level 3.\n"
    " Down:  Bottom of the NW tower, level 1.\n");
...
//   Set(P_COORDINATES, ({ ({ -50,20,0 }), C_SILVERE }) );
   ...
   AddExit("north",  SIL_FORTRESS("nwto22"));
   AddExit("south",  SIL_FORTRESS("webat1"));
   AddExit("east",   SIL_FORTRESS("nobat1"));
   AddExit("west",   SIL_FORTRESS("nwto23"));
   AddExit("up",     SIL_FORTRESS("nwto34"));
   AddExit("down",   SIL_FORTRESS("nwto14"));
