...
varargs void create()
{
   ::create();
   Set(P_INDOORS,1);
   Set(P_INT_SHORT,"Northeastern corner of southeastern tower");
   Set(P_INT_LONG,
   ...
   Set(P_INT_WIZMSG,
    " South: SE Corner of SE tower, level 2.\n"
...
//   Set(P_COORDINATES, ({ ({ -50,20,0 }), C_SILVERE }) );
   ...
   AddExit("south",  SIL_FORTRESS("seto24"));
   AddExit("west",   SIL_FORTRESS("seto21"));
