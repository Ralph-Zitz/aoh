...
"small podestal.\n");
   ...
   Set(P_INT_WIZMSG,
" East: walk around in the eastern wing of the palace.\n"
" West: to the private room of the Lu'meyn, throneroom, entrance.\n"
...
"You walk into the wall like an idiot. Somehow you have the feeling, that\
 everyone laughs at you.\n");
   ...
   AddExit("east",  SIL_PALACE("paleast6"));
   AddExit("west",  SIL_PALACE("paleast3"));
   AddExit("south", SIL_PALACE("paleast5"));
}
