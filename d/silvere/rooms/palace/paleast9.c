...
varargs void create()
{
   ...
   Set(P_INT_LONG,
"A high passage leads in from north and continues to the west. Some "
...
" North: passage leading through the eastern part of the palace.\n");
...
"You walk into the wall like an idiot. Somehow you have the feeling, that\
 everyone laughs at you.\n");
   ...
   AddExit("north", SIL_PALACE("paleast8"));
   AddExit("west",  SIL_PALACE("paleast10"));
}
