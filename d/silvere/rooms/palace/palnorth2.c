...
"south into the private rooms of the Lu'meyna. Two guards are standing "
...
"valuable to them.\n");
   ...
   Set(P_INT_WIZMSG,
" East:  To the eastern part of the palace.\n"
" West:  To the private room of the king.\n"
" South: Enter the private room of the queen.\n");
...
"everyone laughs at you.\n");
   ...
   AddDoor("south", SIL_PALACE("private1"),
