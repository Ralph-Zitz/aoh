...
varargs void create()
{
   ...
   Set(P_INT_LONG,
"A high passage continues from east to south. Two guards are standing "
...
"valuable to them.\n");
   ...
   Set(P_INT_WIZMSG,
" East:  To the eastern part of the palace, private rooms.\n"
" South: To the western part of the palace.\n");
...
"You walk into the wall like an idiot. Somehow you have the feeling, that\
 everyone laughs at you.\n");
   ...
   AddExit("south", SIL_PALACE("palwest3"));
   AddExit("east",  SIL_PALACE("palnorth4"));
}
