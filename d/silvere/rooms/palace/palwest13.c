// A room in the western part of the palace
...
varargs void create()
{
   ...
   Set(P_INT_LONG,
"A high passage leads in from north and continues south. To the north "
"is a small crossing, where another passage leads in from the east. "
...
"that everyone laughs at you.\n");
   ...
   AddExit("north",  SIL_PALACE("palwest2"));
   AddExit("south",  SIL_PALACE("palwest12"));
}
