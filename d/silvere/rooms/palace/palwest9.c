...
varargs void create()
{
   ...
   Set(P_INT_LONG,
"A high passage leads in from north and continues to the east. Some "
...
" North: passage leading through the western part of the palace.\n");
   ...
   Set(P_COORDINATES, ({ ({ -40,30,0 }), C_SILVERE }) );

   Set(P_NOWAY_MSG,
"You walk into the wall like an idiot. Somehow you have the feeling, "
"that everyone laughs at you.\n");

   AddExit("north", SIL_PALACE("palwest8"));
   AddExit("east",  SIL_PALACE("palwest10"));
}
