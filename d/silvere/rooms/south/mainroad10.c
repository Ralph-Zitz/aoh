...
"really here. A small road leads to the west, toward the citypark.\n");
...
" South: to the southern citygate.\n");
   ...
   Set(P_COORDINATES, ({ ({0,140,0 }), C_SILVERE }) );
   Set(P_NOWAY_MSG,
"You walk into a wall like an idiot. Somehow you have the feeling that\
 everyone laughs at you.\n");

   AddExit("west",    SIL_SOUTH("parkroad1"));
   AddExit("north",   SIL_SOUTH("mainroad9"));
   AddExit("south",   SIL_SOUTH("mainroad11"));
}
