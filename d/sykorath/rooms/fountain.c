...
//***********
void fountain() {
  tell_room(TO,"Suddenly the fountain explodes into a huge rush of water.\n");
...
int enter(string str) {
  ...
  if (member(({"basin","small basin","fountain","little fountain"}),
    str)!=-1) {
    write("As you enter the "+str+", your feet get wet.\n");
    return 1;
  }
  return 0;
}
...
create() {
  ...
  AddDetail(({"fountain","little fountain"}),
    "Sometimes the fountain explodes into a huge rush of water. Like a real geyser.\n");
