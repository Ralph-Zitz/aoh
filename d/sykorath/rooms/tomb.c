...
create() {
  ...
  SetIntLong(
    ...
    "You see some spiderwebs around. Looks like that noone was here for a\n"
    "long time.\n");
  SetIndoors(1);
  ...
  /* details */
  AddDetail("tomb",#'IntLong);
  AddDetail(({"chapel","small chapel"}),
    "The small chapel is up (where you come from).\n");
  AddDetail("graveyard",
    "You remember the graveyard, the chapel belongs to it.\n");
