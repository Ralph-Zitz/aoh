...
#include "/d/avalon/common/std/prices.h"
...
*/
  ...
  inhlist = inherit_list(previous_object());
  if(member(inhlist, "d/avalon/common/std/home.c") == -1 &&
     member(inhlist, "d/avalon/common/std/buildplace.c") == -1)
    { FAIL(); }
