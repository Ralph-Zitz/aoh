/* [Softbyte 18sep98] Copied xprops to get xattrs
** 
*/
#include "../bincmd.h"
...
QueryAbrev() { return "xattr"; }
QueryAuthor() {return "Softbyte, Sep1998";}
QueryVersion() {return "V1.0";}
...
int main(string str ) {
  ...
  if ( ( ! str ) || ( str == "?" ) ) 
    return notify_fail( "xattr(s) <object>\n" ), 0;
