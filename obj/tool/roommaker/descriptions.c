 ...
 * description
 *
 * Part of RoomMaker V0.98 (c) Sique 1/1993
 *
 * Author: Sique 9/92
 *
...
nosave string rshort;       /* contains the short description of the room */
nosave string *rlong;       /* contains the lines of the long description */
nosave string *kommentar;   /* contains the lines of the comment to this room */
nosave string menustring;   /* contains the roommaker menu */
