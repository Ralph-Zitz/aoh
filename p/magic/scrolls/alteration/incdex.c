...
int power;
  ...
  dura=750+40*this_player()->QueryInt();   /* It lasts dura sec */
...
{
 ::create();
 AddSpell("inc"+lower_case(STAT),ST_CHANGE,70,#'MyCast,"increase "+LONGSTAT,50);
 SetSpellDesc(
